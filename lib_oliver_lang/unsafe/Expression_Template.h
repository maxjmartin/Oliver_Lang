...
namespace Oliver {
    ...
    public:
        ...
        */
        ...
        template <typename RE>
        auto apply(RE&& re) const -> ExprTemplate<ExprTemplate<LeftExpr, BinaryOp, RightExpr> const&, Apply_Op<value_type>, decltype(std::forward<RE>(re))> {
            return (*this)(re);
        }
        ...
        auto operator()(value_type x) const -> value_type {
