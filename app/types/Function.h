...
namespace Oliver {
    ...
    ////    friend bool    _is_function(const function& self);
    ...
    ////bool _is_function(const function& self) {
    ////    return true;
    ////}
    ...
    ////void function::bind_scope(const map_type& scope) {
    ...
    ////void function::bind_variable(var name, var value) {
    ////    _scope[fmt::format("{}", name)] = value;
    ////}

    ////function::map_type function::variables() const {
    ////    return _scope;
    ////}
    ////
    ////var function::args() const {
    ////    return _args;
    ////}

    ////var function::body() const  {
    ////    return _body;
    ////}

    ////void function::print_enclosure() const {
    ...
    ////bool function::is_bound(const std::string& name) {
    ////    
    ////    var args = _args;
